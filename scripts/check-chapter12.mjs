...
const source = manuscript.slice(manuscript.indexOf('# Chapter 12:'), manuscript.indexOf('# Chapter 13:'));
const chapter = CHAPTERS_LEVEL_3[0];
...
assert.equal(chapter.diagramType, 'advanced_pointers');
...
console.log(`Chapter 12 coverage passed: ${checked} source lines/table cells; 27 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 12.1 '), source.indexOf('## 12.8 '));
