...
const source = manuscript.slice(manuscript.indexOf('# Chapter 11:'), manuscript.indexOf('# Chapter 12:'));
const chapter = CHAPTERS_LEVEL_2[5];
...
assert.equal(chapter.diagramType, 'recursion_locals');
...
console.log(`Chapter 11 coverage passed: ${checked} source lines/table cells; 15 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 11.1 '), source.indexOf('## 11.8 '));
