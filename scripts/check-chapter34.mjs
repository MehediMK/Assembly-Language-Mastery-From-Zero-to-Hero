...
const source = manuscript.slice(manuscript.indexOf('# Chapter 34:'), manuscript.indexOf('# Chapter 35:'));
const chapter = CHAPTERS_LEVEL_6[6];
...
console.log(`Chapter 34 coverage passed: ${checked} source lines/table cells; 16 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 34.1 '), source.indexOf('## 34.8 '));
