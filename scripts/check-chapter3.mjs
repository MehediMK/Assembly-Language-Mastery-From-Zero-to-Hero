...
const source = manuscript.slice(manuscript.indexOf('# Chapter 3:'), manuscript.indexOf('# Chapter 4:'));
const chapter = CHAPTERS_LEVEL_1[2];
...
assert.equal(chapter.diagramType, 'registers_memory');
...
console.log(`Chapter 3 coverage passed: ${checked} source lines/table cells; 18 native sections, 4 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 3.1 '), source.indexOf('## 3.8 '));
