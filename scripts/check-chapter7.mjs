...
const source = manuscript.slice(manuscript.indexOf('# Chapter 7:'), manuscript.indexOf('# Chapter 8:'));
const chapter = CHAPTERS_LEVEL_2[1];
...
assert.equal(chapter.diagramType, 'arithmetic_logical');
...
console.log(`Chapter 7 coverage passed: ${checked} source lines/table cells; 27 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 7.1 '), source.indexOf('## 7.8 '));
