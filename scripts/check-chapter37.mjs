...
const source = manuscript.slice(manuscript.indexOf('# Chapter 37:'), manuscript.indexOf('# Chapter 38:'));
const chapter = CHAPTERS_LEVEL_7[2];
...
assert.equal(chapter.diagramType, 'interrupts_nvic');
...
console.log(`Chapter 37 coverage passed: ${checked} source lines/table cells; 15 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 37.1 '), source.indexOf('## 37.8 '));
