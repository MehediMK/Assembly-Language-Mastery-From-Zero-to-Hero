...
const source = manuscript.slice(manuscript.indexOf('# Chapter 20:'), manuscript.indexOf('# Chapter 21:'));
const chapter = CHAPTERS_LEVEL_4[2];
...
assert.equal(chapter.diagramType, 'inline_assembly');
...
console.log(`Chapter 20 coverage passed: ${checked} source lines/table cells; 24 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 20.1 '), source.indexOf('## 20.10 '));
