...
const source = manuscript.slice(manuscript.indexOf('# Chapter 27:'), manuscript.indexOf('# Chapter 28:'));
const chapter = CHAPTERS_LEVEL_5[4];
...
assert.equal(chapter.diagramType, 'malware_analysis');
...
console.log(`Chapter 27 coverage passed: ${checked} source lines/table cells; 39 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 27.1 '), source.indexOf('## 27.9 '));
