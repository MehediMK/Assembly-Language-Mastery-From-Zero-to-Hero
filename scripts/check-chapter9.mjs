...
const source = manuscript.slice(manuscript.indexOf('# Chapter 9:'), manuscript.indexOf('# Chapter 10:'));
const chapter = CHAPTERS_LEVEL_2[3];
...
assert.equal(chapter.diagramType, 'strings_arrays');
...
console.log(`Chapter 9 coverage passed: ${checked} source lines/table cells; 20 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 9.1 '), source.indexOf('## 9.5 '));
