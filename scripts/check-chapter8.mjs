...
const source = manuscript.slice(manuscript.indexOf('# Chapter 8:'), manuscript.indexOf('# Chapter 9:'));
const chapter = CHAPTERS_LEVEL_2[2];
...
assert.equal(chapter.diagramType, 'control_flow');
...
console.log(`Chapter 8 coverage passed: ${checked} source lines/table cells; 27 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 8.1 '), source.indexOf('## 8.8 '));
