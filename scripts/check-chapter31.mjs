...
const source = manuscript.slice(manuscript.indexOf('# Chapter 31:'), manuscript.indexOf('# Chapter 32:'));
const chapter = CHAPTERS_LEVEL_6[3];
...
assert.equal(chapter.diagramType, 'project_allocator');
...
console.log(`Chapter 31 coverage passed: ${checked} source lines/table cells; 15 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 31.1 '), source.indexOf('## 31.9 '));
