...
const source = manuscript.slice(manuscript.indexOf('# Chapter 16:'), manuscript.indexOf('# Chapter 17:'));
const chapter = CHAPTERS_LEVEL_3[4];
...
assert.equal(chapter.diagramType, 'syscalls_os');
...
console.log(`Chapter 16 coverage passed: ${checked} source lines/table cells; 23 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 16.1 '), source.indexOf('## 16.8 '));
