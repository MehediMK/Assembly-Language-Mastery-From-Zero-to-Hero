...
const source = manuscript.slice(manuscript.indexOf('# Chapter 33:'), manuscript.indexOf('# Chapter 34:'));
const chapter = CHAPTERS_LEVEL_6[5];
...
console.log(`Chapter 33 coverage passed: ${checked} source lines/table cells; 6 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 33.1 '), source.indexOf('## Exercises'));
