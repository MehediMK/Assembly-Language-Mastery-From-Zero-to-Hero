...
const source = manuscript.slice(manuscript.indexOf('# Chapter 17:'), manuscript.indexOf('# Chapter 18:'));
const chapter = CHAPTERS_LEVEL_3[5];
...
assert.equal(chapter.diagramType, 'gdb_debugging');
...
console.log(`Chapter 17 coverage passed: ${checked} source lines/table cells; 23 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 17.1 '), source.indexOf('## 17.13 '));
