...
const source = manuscript.slice(manuscript.indexOf('# Chapter 15:'), manuscript.indexOf('# Chapter 16:'));
const chapter = CHAPTERS_LEVEL_3[3];
...
assert.equal(chapter.diagramType, 'macros_modular');
...
console.log(`Chapter 15 coverage passed: ${checked} source lines/table cells; 18 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 15.1 '), source.indexOf('## 15.8 '));
