...
const source = manuscript.slice(manuscript.indexOf('# Chapter 18:'), manuscript.indexOf('# Chapter 19:'));
const chapter = CHAPTERS_LEVEL_4[0];
...
assert.equal(chapter.diagramType, 'cpu_pipeline_cache');
...
console.log(`Chapter 18 coverage passed: ${checked} source lines/table cells; 31 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 18.1 '), source.indexOf('## 18.10 '));
