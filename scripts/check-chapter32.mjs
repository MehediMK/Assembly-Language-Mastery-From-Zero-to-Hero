...
const source = manuscript.slice(manuscript.indexOf('# Chapter 32:'), manuscript.indexOf('# Chapter 33:'));
const chapter = CHAPTERS_LEVEL_6[4];
...
assert.equal(chapter.diagramType, 'project_c_integration');
...
console.log(`Chapter 32 coverage passed: ${checked} source lines/table cells; 17 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 32.1 '), source.indexOf('## 32.12 '));
