...
const source = manuscript.slice(manuscript.indexOf('# Chapter 19:'), manuscript.indexOf('# Chapter 20:'));
const chapter = CHAPTERS_LEVEL_4[1];
...
assert.equal(chapter.diagramType, 'abi_register_alloc');
...
console.log(`Chapter 19 coverage passed: ${checked} source lines/table cells; 24 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 19.1 '), source.indexOf('## 19.7 '));
