...
const source = manuscript.slice(manuscript.indexOf('# Chapter 6:'), manuscript.indexOf('# Chapter 7:'));
const chapter = CHAPTERS_LEVEL_2[0];
...
assert.equal(chapter.diagramType, 'addressing_modes');
...
console.log(`Chapter 6 coverage passed: ${checked} source lines/table cells; 29 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 6.1 '), source.indexOf('## 6.8 '));
