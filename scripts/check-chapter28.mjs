...
const source = manuscript.slice(manuscript.indexOf('# Chapter 28:'), manuscript.indexOf('# Chapter 29:'));
const chapter = CHAPTERS_LEVEL_6[0];
...
assert.equal(chapter.diagramType, 'project_calculator');
...
console.log(`Chapter 28 coverage passed: ${checked} source lines/table cells; 12 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 28.1 '), source.indexOf('## 28.7 '));
