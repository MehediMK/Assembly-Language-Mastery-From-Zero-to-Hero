...
const source = manuscript.slice(manuscript.indexOf('# Chapter 29:'), manuscript.indexOf('# Chapter 30:'));
const chapter = CHAPTERS_LEVEL_6[1];
...
assert.equal(chapter.diagramType, 'project_string_lib');
...
console.log(`Chapter 29 coverage passed: ${checked} source lines/table cells; 24 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 29.1 '), source.indexOf('## 29.8 '));
