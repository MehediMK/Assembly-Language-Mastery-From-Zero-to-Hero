...
const source = manuscript.slice(manuscript.indexOf('# Chapter 36:'), manuscript.indexOf('# Chapter 37:'));
const chapter = CHAPTERS_LEVEL_7[1];
...
assert.equal(chapter.diagramType, 'mmio_peripherals');
...
console.log(`Chapter 36 coverage passed: ${checked} source lines/table cells; 24 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 36.1 '), source.indexOf('## 36.10 '));
