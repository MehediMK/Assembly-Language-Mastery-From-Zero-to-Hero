...
const source = manuscript.slice(manuscript.indexOf('# Chapter 38:'), manuscript.indexOf('# Chapter 39:'));
const chapter = CHAPTERS_LEVEL_7[3];
...
assert.equal(chapter.diagramType, 'low_power');
...
console.log(`Chapter 38 coverage passed: ${checked} source lines/table cells; 17 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 38.1 '), source.indexOf('## 38.8 '));
