...
const source = manuscript.slice(manuscript.indexOf('# Chapter 4:'), manuscript.indexOf('# Chapter 5:'));
const chapter = CHAPTERS_LEVEL_1[3];
...
assert.equal(chapter.diagramType, 'toolchain_pipeline');
...
console.log(`Chapter 4 coverage passed: ${checked} source lines/table cells; 20 native sections, 5 interactive exercises, 10 answered questions.`);

const body = source.slice(source.indexOf('## 4.1 '), source.indexOf('## 4.11 '));
